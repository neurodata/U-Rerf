#' Unsupervised RerF
#'
#' Creates the forest and supporting data that makes up the urerf structure. 
#'
...
#' @param K the minimum leaf node size.  Use of K increases liklihood that nodes will contain multiple observations. (K = 3)
...
urerf <- 
	function(X, numTrees=100, K=3, depth=NA){
